...
class SessionManager:
    ...
    async def resolve_peer_by_phone(
        ...
        if getattr(self._manager, "resolve_peer_by_phone", None) is None:
            raise AttributeError("resolve_peer_by_phone_unsupported")
        return await self._manager.resolve_peer_by_phone(tenant_id, phone)
