...
from libs.core.catalog.pdf_catalog_miniprog import CatalogMiniPipeline, _normalize_text
from libs.core.catalog.io import write_catalog_csv
...
def test_smoke_pipeline_creates_csv(tmp_path, monkeypatch):
    ...
    from libs.core.catalog import io as catalog_io
