...
from apps.api.web.public import TgWorkerCallError
...
def _base_app(monkeypatch, public_key: str = "public-key") -> FastAPI:
    ...
    monkeypatch.setattr(public_module.settings, "WORKER_BASE_URL", "http://tgworker.test")
    monkeypatch.setattr(public_module.settings, "TGWORKER_BASE_URL", "http://tgworker.test")
