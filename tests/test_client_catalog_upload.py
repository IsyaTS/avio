...
def api_client(tmp_path, monkeypatch):
    ...
    from apps.api.web import common as web_common, client as web_client, public as web_public

    modules = (core, web_common, web_client, web_public, app_main)
...
def test_public_catalog_upload_csv_and_pdf_with_query_tenant(api_client, tmp_path):
    ...
    assert isinstance(pdf_rel, str) and pdf_rel.endswith(".csv")
